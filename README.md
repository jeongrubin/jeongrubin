...
[별도 포트폴리오 저장소](https://github.com/jeongrubin/Portfolio-JeongSubin)
...
차선 손상 등급 분류: 2024.03–2024.07  
손상 영역 라벨링(팀 공동 작업): 2024.04  
픽셀 단위 세그멘테이션 모델 학습: 2026.09

차량 카메라 이미지로 차선의 손상 등급을 분류했습니다. 같은 프로젝트를 진행한 팀원들과 2024년 4월에 손상 영역을 폴리곤으로 라벨링해뒀는데, 다른 서버에 있어 한동안 활용하지 못하다가 2026년에 다시 확보해 U-Net 세그멘테이션 모델을 학습했습니다.
